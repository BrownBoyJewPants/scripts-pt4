...
{ 
Vector3 localScale = this.textLabel.transform.localScale;
string text2;
this.textLabel.font.WrapText(paragraph.text, out text2, this.maxWidth / localScale.x, this.maxHeight / localScale.y, this.textLabel.maxLineCount, this.textLabel.supportEncoding, this.textLabel.symbolStyle);
