...
{ 
Vector3 localScale = this.label.cachedTransform.localScale;
if (this.label.multiLine)
{ 
this.label.font.WrapText(text, out text, (float)this.label.lineWidth / localScale.x, (float)this.label.lineHeight / localScale.y, 0, false, UIFont.SymbolStyle.None);
}
else
{ 
string endOfLineThatFits = this.label.font.GetEndOfLineThatFits(text, (float)this.label.lineWidth / localScale.x, false, UIFont.SymbolStyle.None);
