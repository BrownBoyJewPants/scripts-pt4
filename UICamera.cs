...
{ 
UICamera.hoveredObject = ((!UICamera.Raycast(Input.mousePosition, out UICamera.lastHit)) ? UICamera.fallThrough : UICamera.lastHit.collider.gameObject);
...
UICamera.hoveredObject = ((!UICamera.Raycast(UICamera.currentTouch.pos, out UICamera.lastHit)) ? UICamera.fallThrough : UICamera.lastHit.collider.gameObject);
if (UICamera.hoveredObject == null)
{ 
UICamera.hoveredObject = UICamera.genericEventHandler;
}
