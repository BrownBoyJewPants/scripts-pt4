...
this.mPanel = base.GetComponent<UIPanel>();
UIPanel expr_1E = this.mPanel;
expr_1E.onChange = (UIPanel.OnChangeDelegate)Delegate.Combine(expr_1E.onChange, new UIPanel.OnChangeDelegate(this.OnPanelChange));
expr_1E
}
...
if (this.mPanel != null)
{ 
UIPanel expr_17 = this.mPanel;
expr_17.onChange = (UIPanel.OnChangeDelegate)Delegate.Remove(expr_17.onChange, new UIPanel.OnChangeDelegate(this.OnPanelChange));
}
expr_17
}
...
{ 
UIScrollBar expr_1E = this.horizontalScrollBar;
expr_1E.onChange = (UIScrollBar.OnScrollBarChange)Delegate.Combine(expr_1E.onChange, new UIScrollBar.OnScrollBarChange(this.OnHorizontalBar));
...
{ 
UIScrollBar expr_86 = this.verticalScrollBar;
expr_86.onChange = (UIScrollBar.OnScrollBarChange)Delegate.Combine(expr_86.onChange, new UIScrollBar.OnScrollBarChange(this.OnVerticalBar));
