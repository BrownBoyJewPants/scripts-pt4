...
Vector2 vector = this.mLabel.cachedTransform.localScale;
this.mLabel.font.WrapText(this.mLabel.text, out this.mText, (float)this.mLabel.lineWidth / vector.x, (float)this.mLabel.lineHeight / vector.y, this.mLabel.maxLineCount, false, UIFont.SymbolStyle.None);
}
